  ...
  <section class="flex justify-center items-center py-20 px-4">
    <div class="bg-white text-black rounded-2xl shadow-lg w-full max-w-4xl p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
        <a href="#" class="bg-blue-700 hover:bg-blue-600 text-white p-6 rounded-xl flex items-center justify-between transition-colors">
          <div>
        ...
        <a href="#" class="bg-green-700 hover:bg-green-600 text-white p-6 rounded-xl flex items-center justify-between transition-colors">
          <div>
        ...
        <a href="#" class="bg-yellow-700 hover:bg-yellow-600 text-white p-6 rounded-xl flex items-center justify-between transition-colors">
          <div>
        ...
        <a href="#" class="bg-purple-700 hover:bg-purple-600 text-white p-6 rounded-xl flex items-center justify-between transition-colors">
          <div>
        ...
        <div class="bg-gray-50 p-4 rounded-xl">
          <div class="space-y-3">
            <div class="flex items-center justify-between">
              <span class="text-sm">New user registration: John Doe</span>
              <span class="text-xs text-gray-500">2 minutes ago</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-sm">Task completed: Video Watch Task</span>
              <span class="text-xs text-gray-500">5 minutes ago</span>
            </div>
            <div class="flex items-center justify-between">
              <span class="text-sm">Withdrawal request: ₪5,000</span>
